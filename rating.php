    ...
    <form id="form" action="submit_rating.php" method="post" class="container">
        ...
        <div class="frq-container">
            <div class="long-frq">
                ...
                <textarea id="comments" name="description" class="long-frq-text" required></textarea>
                <label>
                    <h4>
                ...
                <textarea id="comments" name="suggestion" class="long-frq-text" required></textarea>
            </div>
            ...
            <div class="short-frq">
                ...
                <input type="text" name="name" class="short-frq-text" required></textarea>
                <label>
                    <h4>
